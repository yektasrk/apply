...
- `/Users/yekta/Desktop/Apply/.codex/skills/triage-job-applications/references/current-sheet.md` for the current spreadsheet, tabs, headers, and timezone. This file is local-only; use `current-sheet.example.md` as the tracked template.
- `/Users/yekta/Desktop/Apply/wiki/topics/job-application-form-defaults.md` for stable candidate details and fields that require user confirmation.
- `/Users/yekta/Desktop/Apply/resume.md` for factual evidence.
- The row's `cover_letter_path` file.
- [browser-form-flow.md](references/browser-form-flow.md) before operating a web form.

Use `/Users/yekta/Desktop/Apply/CV - Yekta Sarkamari.pdf` whenever a form asks for a resume or CV upload.
