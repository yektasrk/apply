...
# Resume-verified skills (canonical names). Source of truth = resume.md, NOT any
# prose baseline. Used symmetrically: a GAP must NOT be in this set (you can't lack
# what you have), and a STRENGTH must be IN it (a fit driver must be resume-backed).
# NOTE: Terraform and public cloud (AWS/Azure/GCP) are deliberately absent — the
# resume's IaC is Ansible-based and its only cloud item is S3/MinIO storage.
RESUME_SKILLS = {"Kubernetes", "Ansible", "Docker", "Python", "Go", "Kafka",
                 "CI/CD", "Linux", "Observability/Monitoring", "Incident/On-call",
                 "SLI/SLO", "High Availability", "Automation", "Platform/DevEx"}
