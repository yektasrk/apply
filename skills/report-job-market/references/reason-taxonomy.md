...
Candidate-specific facts are intentionally not stored in this public repository.
Load the private resume and application defaults at runtime, and treat skills,
location, authorization, language, clearance, and experience claims as unknown
until supported by those private sources or explicit user input.
